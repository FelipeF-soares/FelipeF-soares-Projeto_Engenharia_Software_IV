...
namespace SmartCondWeb.DataAcess.Migrations
{
    ...
    partial class SmartCondContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("SmartCondWeb.Domain.Things.Vehicle", b =>
                {
                    ...
                    b.Property<string>("BuildingRentedBuider")
                        .HasColumnType("longtext");
                    ...
                    b.Property<string>("RentedFullName")
                        .HasColumnType("longtext");

                    b.Property<string>("RentedUnitNumber")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("SmartCondWeb.Domain.Things.Vehicle", b =>
                {
                    b.HasOne("SmartCondWeb.Domain.Things.Unit", "Unit")
                        .WithOne("Vehicles")
                        .HasForeignKey("SmartCondWeb.Domain.Things.Vehicle", "UnitId")
                        .OnDelete(DeleteBehavior.SetNull);
